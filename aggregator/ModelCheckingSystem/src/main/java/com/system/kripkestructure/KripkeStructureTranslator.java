...
public class KripkeStructureTranslator {
    ...
    private boolean translateIf(List<Object> current, int pc) {
        ...
        //get OBDD decribing the transition to the next state
    ...
    private boolean translateElse(List<Object> current, int pc) {
        ...
        switch (stateType) {//determine a type of the next state
            case ASSIGN:
                logger.log(Level.INFO, "Translating assign");
        ...
        }//we don't know what is the next state
        return false;
    }
    
    //Absolutely similar to the translateIf method, excepting looping and absence of ELSE
    private boolean translateWhile(List<Object> current, int pc) {
        ...
        if (conditionValue) {
            ...
            switch (stateType) {
                ...
                case END_OF_GROUP://here is the end of while, if or else
                    logger.log(Level.INFO, "Translating end of group");
                    return translateEndOfGroup(current, thenPC);
    ...
    //Translates the operation of assignment of the value or the result of 
    //the expression to one of the variables
    ...
    //Translating the operation of read using the bruteforce technique
        ...
        switch (stateType) {
            case ASSIGN:
                ...
                switch (variable.getType()) {
                    //switch to support easily other variables types in the future
                    case INTEGER://here the bruteforce is
    ...
    //This method translates end of the group; for example, WHILE, IF or ELSE
    ...
    //This method finishes the translation of the program
