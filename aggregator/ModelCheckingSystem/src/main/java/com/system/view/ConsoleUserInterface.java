...
public class ConsoleUserInterface {
    ...
    private static final String PREDICATE_MESSAGE = "Enter condition of atomic predicate";
    ...
    private static final String EXAMPLES_ANSWER = "How many counterexamples do you want to have?";
    ...
    public void doWork() {
        ...
        do {
            forAtomicPredicates.add(readNotEmptyString(PREDICATE_MESSAGE));
        }
